...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-video'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  kanox_blog_posts_meta
		 *
		 * @Hooked kanox_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'kanox_blog_posts_meta' );
		 ...
		 * @Hook  kanox_blog_posts_excerpt
		 *
		 * @Hooked kanox_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'kanox_blog_posts_excerpt' );
