    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = kanox_opt( 'kanox_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo kanox_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( kanox_featured_post_cat() ){
                                echo '<span class="entry__category">'.kanox_featured_post_cat().'</span>';
                            }
                            ?>
