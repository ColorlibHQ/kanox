 ...
 */
	...
	class kanox_Enqueue{
		...
		public function kanox_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'kanox_frontend_enqueue_scripts', ) );
		}

		public function kanox_frontend_enqueue_scripts( ){
