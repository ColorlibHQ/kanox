...
----------------------------------------*/
class kanox_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('kanox_instagram_photo',esc_html__('[ Kanox ] Intagram Photo','kanox'),array(
			'description' => esc_html__('Kanox Instagram Photo Widget','kanox'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'kanox');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'kanox'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'kanox'); ?></label>
...
if(!function_exists('kanox_instagram_widgets')):
	function kanox_instagram_widgets(){
		register_widget('kanox_instagram_photo');
	}
	add_action('widgets_init','kanox_instagram_widgets');
endif;
