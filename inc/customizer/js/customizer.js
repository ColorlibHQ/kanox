(function( $ , api){
    ...
    api.section( 'kanox_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'kanox_about_section' , function( section ){
    ...
    api.section( 'kanox_blog_section' , function( section ){
    ...
    api.section( 'kanox_portfolio_section' , function( section ){
    ...
    api.section( 'kanox_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-kanox_contact_custom_formshortcode'),
                selector = $('#_customize-input-kanox_contact_formshortcode');
    ...
    // General section
    api.section( 'kanox_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#kanox_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-kanox_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-kanox_preloader_color' );
            ...
            var $backtotop          = $( '#kanox_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-kanox_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-kanox_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'kanox_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#kanox_footer_widget_toggle');
