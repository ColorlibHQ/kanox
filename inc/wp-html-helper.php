...
// image default alt
if( !function_exists( 'kanox_img_default_alt' ) ){
	function kanox_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'kanox_img_tag' ) ){
	function kanox_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'kanox_anchor_tag' ) ){
	function kanox_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'kanox_heading_tag' ) ){
	function kanox_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'kanox_paragraph_tag' ) ){
	function kanox_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'kanox_other_tag' ) ){
	function kanox_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'kanox_button_element ' ) ){
	function kanox_button_element( array $args ){
